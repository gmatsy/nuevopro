...
<span class="img-price" onclick="clickDescriptionPr(607, 0)" style="color:#ffff;"id="1.5">$99.00</span></div>
    <a type="button" class="btn  btn-warning" id="btn1" onclick="proce()" href="carro.jsp?id=3000"><img src="https://img.icons8.com/windows/32/000000/shopping-cart.png">Añadir</a>&nbsp;
    <button type="button" id="btn-one" class="btn btn-primary"href="#" onclick="click1()" type="button" data-toggle="modal" data-target="#exampleModal"><img src="https://img.icons8.com/dotty/32/000000/return-purchase.png">Comprar</button>
...
<a type="button" class="btn  btn-warning" id="btn1" onclick="proce()" href="carro.jsp?id=3001"><img src="https://img.icons8.com/windows/32/000000/shopping-cart.png">Añadir</a>&nbsp;
   <button type="button" id="btn-two" class="btn btn-primary"href="#" type="button" data-toggle="modal" data-target="#exampleModal"><img src="https://img.icons8.com/dotty/32/000000/return-purchase.png">Comprar</button>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="card-body">
    ...
    <div class="price-radio">
       ...
       <a type="button" class="btn  btn-warning" id="btn1" onclick="proce()" href="carro.jsp?id=3002"><img src="https://img.icons8.com/windows/32/000000/shopping-cart.png">Añadir</a>&nbsp;
<button type="button" id="btn-tres" class="btn btn-primary"href="#" type="button" data-toggle="modal" data-target="#exampleModal"><img src="https://img.icons8.com/dotty/32/000000/return-purchase.png">Comprar</button>
...
<a type="button" class="btn  btn-warning" id="btn1" onclick="proce()" href="carro.jsp?id=3003"><img src="https://img.icons8.com/windows/32/000000/shopping-cart.png">Añadir</a>&nbsp;
<button  type="button" id="btn-cuatro" class="btn btn-primary"href="#" type="button" data-toggle="modal" data-target="#exampleModal"><img src="https://img.icons8.com/dotty/32/000000/return-purchase.png">Comprar</button>
